    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 relative">
            <div className="relative">
              ...
              <h2 className="absolute bottom-4 left-4 text-4xl font-bold text-white">designer</h2>
              <p className="absolute top-4 left-4 text-xs text-white opacity-80">I make beautiful websites, and create <br/> unique designs and design systems.</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 md:pl-8 relative">
            <div className="relative">
              <img 
                ...
                className="w-full object-cover rounded"
              />
              <h2 className="absolute bottom-4 right-4 text-4xl font-bold text-white">&lt;coder&gt;</h2>
              <p className="absolute top-4 right-4 text-xs text-white text-right opacity-80">I write clean, elegant and efficient code <br/> using modern web technologies.</p>
      ...
      <section className="bg-yellow-400 py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-white">It is a website about my UX designs, it contains my projects</p>
          </div>
      ...
      <section className="bg-red-400 py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse items-center">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pl-12">
            <h2 className="text-4xl font-bold text-white mb-2">Graphic Designs</h2>
            <h3 className="text-3xl font-bold text-white mb-6">Portfolio</h3>
            <p className="text-white">It is a website about my UX designs, it contains my projects</p>
          </div>
          <div className="w-full md:w-1/2 flex justify-center">
      ...
      <section className="bg-gray-900 py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-white mb-8">It is a website about my UX designs, it contains my projects</p>
          
          <div className="mt-8 text-center">
            <Link to="/portfolio" className="inline-block px-6 py-3 bg-white text-gray-900 font-bold rounded hover:bg-gray-100 transition">
              View All Projects
            </Link>
          </div>
        </div>
